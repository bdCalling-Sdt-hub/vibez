                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Column(
                      ...
                      children: [
                        CustomText(
                            text: widget.filter![index].name.toString(),
                            fontsize: 17.h,
                            top: 20.h,
                            bottom: 12.h),
                        // ✅ Filter Name
                        _buttons(widget.filter![index].subfilters ?? []),
        ...
        return GestureDetector(
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                color:
                    selectedIdList.contains(x.id) ? Colors.blue : Colors.white,
                borderRadius: BorderRadius.circular(20),
              ),
              child: CustomText(
                text: "${x.value}",
                color:
                    selectedIdList.contains(x.id) ? Colors.white : Colors.black,
              )),
        );
      }).toList(),
    );
