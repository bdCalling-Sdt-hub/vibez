...
class RatingScreen extends StatefulWidget {
  ...
  const RatingScreen({super.key, required this.category, required this.eventId});
...
class _RatingScreenState extends State<RatingScreen> {
  ...
  late List<Map<String, dynamic>> ratingItems;

  @override
  void initState() {
    super.initState();
    ratingItems = getRatingItems(widget.category);
    setState(() {});
  }

  List<Map<String, dynamic>> getRatingItems(String category) {
    if (category == "bars" || category == "night-clubs") {
      return [
    ...
    } else if (category == "ticketed-parties") {
      return [
        {"title": "Music", "value": 3.2},
        {"title": "Ambience", "value": 3.2},
    ...
    }else if(category == "party-restaurant"){
      return [
        {"title": "Food", "value": 3.2},
        {"title": "Service", "value": 3.2},
        {"title": "Ambience", "value": 3.2},
  ...
  void _updateRating(int index, double newValue) {
    setState(() {
      ratingItems[index]["value"] = newValue; // মান আপডেট
    });
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          GestureDetector(
              ...
              child: CustomText(
                  text: "Clear All", color: AppColors.textColor808080)),
          SizedBox(width: 20.w)
        ],
      ),
          ...
          children: [
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _customRating(item["title"], item["value"],
                    (val) => _updateRating(index, val));
              },
            ),
            Padding(
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child:
                      CustomText(text: sliderValue.toString(), fontsize: 10.h),
                ),
              ),
            ],
          ),
