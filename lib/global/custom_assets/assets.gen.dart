...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/chock.svg
  SvgGenImage get chock => const SvgGenImage('assets/icons/chock.svg');
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [aboutUs, applogo, onboardingImage];
}
